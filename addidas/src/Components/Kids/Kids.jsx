...
export default function Kids() {
  return (
    <div>
      <div>
        <img src='https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_1920,w_1920/enIN/Images/adidas-lego-originals-ss22-flex-launch-clp-masthead-d_tcm209-823156.jpg' className="bground"></img>
        <img src='https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/enIN/Images/H23161_BOS_LOGO_lockup_white_tcm209-816446.png' className="logo"></img>
        <h1 className='text'>IMAGINE YOUR WORLD</h1>
        <p className='text1'>Turn on your imagination and play with the new exclusive adidas LEGO® Originals collection. Now available.</p>
